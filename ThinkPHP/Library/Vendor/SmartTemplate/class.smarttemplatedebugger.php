	...
	class SmartTemplateDebugger
	{
		...
		*/
		function start ( $vars )
		{
			...
			echo '<li><a href="#data_code">Loss</a></li>';
			echo '</b></font><hr>';
			...
			// Print Data
			echo '<a name="data_code"><br><br><font face="Arial" Size="3"><b>Loss:</b>&nbsp;[<a href="javascript:void(\'\');" onclick="toggleVisibility(document.getElementById(Loss), this); return false">Hide Ouptut</a>]</font><br>';
